...
use App\Models\CmfHrmsFileLizhi;
...
class CmfHrmsFileLizhiController extends AdminController {

	protected $title = "离职信息";
    ...
    protected function grid() {
        ...
        {
                $form = new Form(new CmfHrmsFileLizhi());
                $form->text('workId', __('工号'))
                ->creationRules('required|max:200|unique:cmf_hrms_file_lizhi',
        ...
        {
        $show = new Show(CmfHrmsFileLizhi::findOrFail($id));
