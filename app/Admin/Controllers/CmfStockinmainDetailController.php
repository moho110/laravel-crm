...
use App\Models\CmfStockinmainDetail;
...
class CmfStockinmainDetailController extends AdminController {

	protected $title = "入库明细";
    ...
    protected function grid() {
                $grid = new Grid(new CmfStockinmainDetail());
        ...
        {
                $form = new Form(new CmfStockinmainDetail());
                $form->text('prodid', __('产品ID'))
                ->creationRules('required|max:200|unique:cmf_stockinmain_detail',
        ...
        {
        $show = new Show(CmfStockinmainDetail::findOrFail($id));
