...
class CmfSystemInforController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new CmfSystemInfor());
        ...
        {
                $form = new Form(new CmfSystemInfor());
        ...
        {
        $show = new Show(CmfSystemInfor::findOrFail($id));
