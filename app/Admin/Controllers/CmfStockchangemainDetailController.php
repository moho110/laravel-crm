...
use App\Models\CmfStockchangemainDetail;
...
class CmfStockchangemainDetailController extends AdminController {

	protected $title = "仓库调拔明细";
    ...
    protected function grid() {
                $grid = new Grid(new CmfStockchangemainDetail());
        ...
        {
                $form = new Form(new CmfStockchangemainDetail());
                $form->text('prodid', __('产品ID'))
                ->creationRules('required|max:200|unique:cmf_stockchangemain_detail',
        ...
        {
        $show = new Show(CmfStockchangemainDetail::findOrFail($id));
