...
class CmfCrmMytableController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new CmfCrmMytable());
        ...
        {
                $form = new Form(new CmfCrmMytable());
        ...
        {
        $show = new Show(CmfCrmMytable::findOrFail($id));
