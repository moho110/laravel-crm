...
class CmfMyConfigController extends AdminController {
    ...
    protected function grid() {
        ...
        {
        $show = new Show(CmfMyConfig::findOrFail($id));
