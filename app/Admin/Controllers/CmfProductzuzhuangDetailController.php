...
use App\Models\CmfProductzuzhuangDetail;
...
class CmfProductzuzhuangDetailController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new CmfProductzuzhuangDetail());
        ...
        {
                $form = new Form(new CmfProductzuzhuangDetail());
                $form->select('prodid', __('产品ID'))
                ->options(CmfProduct::pluck('productname','id'))
                ->creationRules('required|max:200|unique:cmf_productzuzhuang_detail',
        ...
        {
        $show = new Show(CmfProductzuzhuangDetail::findOrFail($id));
