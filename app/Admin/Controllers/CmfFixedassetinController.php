...
use App\Models\CmfFixedassetin;
...
class CmfFixedassetinController extends AdminController {

	protected $title = "固定资产入库";
    ...
    protected function grid() {
                $grid = new Grid(new CmfFixedassetin());
        ...
        {
                $form = new Form(new CmfFixedassetin());
                $form->text('setName', __('资产名称'))
                ->creationRules('required|max:200|unique:cmf_fixedassetin',
        ...
        {
        $show = new Show(CmfFixedassetin::findOrFail($id));
