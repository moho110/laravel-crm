...
class CmfSysConfigController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new CmfSysConfig());
        ...
        {
                $form = new Form(new CmfSysConfig());
        ...
        {
        $show = new Show(CmfSysConfig::findOrFail($id));
