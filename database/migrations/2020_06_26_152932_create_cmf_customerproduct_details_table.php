...
class CreateCmfCustomerproductDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cmf_customerproduct_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cmf_customerproduct_detail');
    }
}
