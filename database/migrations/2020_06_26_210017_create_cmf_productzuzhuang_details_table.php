...
class CreateCmfProductzuzhuangDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cmf_productzuzhuang_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cmf_productzuzhuang_detail');
    }
}
