...
class CreateCmfProductzuzhuang2DetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cmf_productzuzhuang2_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cmf_productzuzhuang2_detail');
    }
}
