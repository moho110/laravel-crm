...
class CreateCmfStockchangemainDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cmf_stockchangemain_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('cmf_stockchangemain_detail');
    }
}
